...
# XXD Panel 210｜كولاج تصويري مفاهيمي خفيف وبارد
...
كولاج تصويري مفاهيمي خفيف وبارد
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 210 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-210`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-210 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-210-prompt.en.md) أو [بالصينية](references/xxd-panel-210-prompt.zh-CN.md).
